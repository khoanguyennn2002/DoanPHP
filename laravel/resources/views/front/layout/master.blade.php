            ...
            <div class="inner-header">
                <div class="row">
                    <div class="col-lg-2 col-md-2">
                        <div class="logo"><a href="index.html">THEWATCHSHOP</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 text-right">
                        <ul class="nav-right">
                                ...
                                <div class="cart-hover">
                                    <div class="select-items">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="si-pic"><img src="Gsockpic/2.jpg" height="100" alt="">
                                                    </td>
                                                    <td class="si-text">
                            ...
                            <li class="cart-icon ml-5">
                                <a href="login.html" class="login-panel"><i class="fa fa-user-o"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
